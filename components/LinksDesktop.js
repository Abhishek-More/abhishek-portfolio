...
export default function LinksDesktop() {
  return (
    <div className="hidden lg:flex justify-between w-[65%] lg:w-[75%] xl:w-[65%] m-auto pt-20">
        <a className="text-3xl font-bold blend" href="https://firebasestorage.googleapis.com/v0/b/asciify-a4fba.appspot.com/o/Abhishek%20More%20Resume.pdf?alt=media&token=84cf5ee1-8480-4338-a511-bb9be33bbeed" target="_blank" rel="noopener noreferrer">Resume &rarr;</a>
